...
class I18n:
    ...
    TEXTS = {
        ...
        "app_subtitle": {"zh": "多材料3D打印色彩系统 | v1.6.3", "en": "Multi-Material 3D Print Color System | v1.6.3"},
        ...
        "conv_lut_title": {"zh": "**校准数据**", "en": "**Calibration Data**"},
        ...
        "crop_auto_color": {"zh": "🎨 计算最佳色彩细节", "en": "🎨 Calculate optimal color detail"},
        "conv_params_section": {"zh": "#### ⚙️ 参数", "en": "#### ⚙️ Parameters"},
        "conv_color_mode": {"zh": "色彩模式", "en": "Color Mode"},
        "conv_color_mode_cmyw": {"zh": "CMYW (青/品红/黄)", "en": "CMYW (Cyan/Magenta/Yellow)"},
        "conv_color_mode_rybw": {"zh": "RYBW (红/黄/蓝)", "en": "RYBW (Red/Yellow/Blue)"},
        "conv_structure": {"zh": "结构", "en": "Structure"},
        "conv_structure_double": {"zh": "双面 (钥匙扣)", "en": "Double-sided (Keychain)"},
        ...
        "conv_quantize_info": {"zh": "颜色数量越多细节越丰富，但生成越慢", "en": "Higher = More detail, Slower"},
        "conv_auto_color_btn": {"zh": "🔍 自动计算", "en": "🔍 Auto Detect"},
        "conv_auto_color_calculating": {"zh": "⏳ 计算中...", "en": "⏳ Calculating..."},
        "conv_auto_bg": {"zh": "🗑️ 移除背景", "en": "🗑️ Remove Background"},
        "conv_auto_bg_info": {"zh": "自动移除图像背景色", "en": "Auto remove background"},
        "conv_tolerance": {"zh": "容差", "en": "Tolerance"},
        "conv_tolerance_info": {"zh": "背景容差值 (0-150)，值越大移除越多", "en": "Higher = Remove more"},
        "conv_width": {"zh": "宽度 (mm)", "en": "Width (mm)"},
        "conv_height": {"zh": "高度 (mm)", "en": "Height (mm)"},
        "conv_thickness": {"zh": "背板 (mm)", "en": "Backing (mm)"},
        "conv_backing_color": {"zh": "底板颜色", "en": "Backing Color"},
        ...
        "conv_palette_step1": {"zh": "### 1. 原图颜色（点击预览图）", "en": "### 1. Original Color (Click Preview)"},
        "conv_palette_step2": {"zh": "### 2. 替换为（点击色块）", "en": "### 2. Replace With (Click Swatch)"},
        "conv_palette_selected_label": {"zh": "当前选中", "en": "Selected"},
        "conv_palette_replace_label": {"zh": "将替换为", "en": "Replace With"},
        "conv_palette_lut_loading": {"zh": "⏳ 正在加载 LUT 颜色...", "en": "⏳ Loading LUT colors..."},
        "conv_palette_replacements_placeholder": {
            "zh": "生成预览后显示替换列表",
            "en": "Generate preview to see replacements",
        },
        "conv_palette_replacements_label": {"zh": "已生效的替换", "en": "Applied Replacements"},
        ...
        "conv_palette_user_replacements_title": {"zh": "用户替换", "en": "User Replacements"},
        "conv_palette_auto_pairs_title": {"zh": "自动配准", "en": "Auto Pairs"},
        "conv_palette_delete_selected_btn": {"zh": "删除选中", "en": "Delete Selected"},
        "conv_palette_delete_selected_empty": {
            "zh": "❌ 请先选中一项用户替换",
            "en": "❌ Select one user replacement first",
        },
        "conv_palette_user_empty": {"zh": "暂无替换", "en": "No replacements"},
        "conv_palette_auto_empty": {"zh": "暂无自动配准", "en": "No auto pairs"},
        "lut_grid_invalid": {"zh": "⚠️ 请先选择一个有效的 LUT 文件", "en": "⚠️ Please select a valid LUT file"},
        "lut_grid_header": {
            "zh": "🎨 当前 LUT 包含 <b>{count}</b> 种可打印颜色（点击选择）",
            "en": "🎨 Current LUT contains <b>{count}</b> printable colors (click to select)",
        },
        "conv_loop_section": {"zh": "##### 🔗 挂孔设置", "en": "##### 🔗 Loop Settings"},
        ...
        "conv_outline_section": {"zh": "##### 外轮廓设置", "en": "##### Outline Settings"},
        "conv_outline_enable": {"zh": "启用外轮廓", "en": "Enable Outline"},
        "conv_outline_width": {"zh": "轮廓宽度(mm)", "en": "Outline Width(mm)"},
        "conv_cloisonne_section": {"zh": "##### 掐丝珐琅特效", "en": "##### Cloisonné Effect"},
        "conv_cloisonne_enable": {"zh": "启用掐丝珐琅", "en": "Enable Cloisonné"},
        "conv_cloisonne_wire_width": {"zh": "丝线宽度(mm)", "en": "Wire Width(mm)"},
        "conv_cloisonne_wire_height": {"zh": "丝线高度(mm)", "en": "Wire Height(mm)"},
        "conv_cloisonne_wire_color": {"zh": "丝线颜色槽位", "en": "Wire Color Slot"},
        "conv_free_color_btn": {"zh": "🎯 标记为自由色", "en": "🎯 Mark as Free Color"},
        "conv_free_color_clear_btn": {"zh": "清除自由色", "en": "Clear Free Colors"},
        "conv_coating_section": {"zh": "##### 透明镀层", "en": "##### Transparent Coating"},
        "conv_coating_enable": {"zh": "启用透明镀层", "en": "Enable Coating"},
        "conv_coating_height": {"zh": "镀层厚度(mm)", "en": "Coating Height(mm)"},
        ...
        # ==================== Calibration Tab ====================
        "cal_title": {"zh": "### 第二步：生成校准板", "en": "### Step 2: Generate Calibration Board"},
        "cal_desc": {
        ...
        # ==================== Color Extractor Tab ====================
        "ext_title": {"zh": "### 第三步：提取颜色数据", "en": "### Step 3: Extract Color Data"},
        "ext_desc": {
        ...
        "ext_correction_section": {"zh": "#### 🔧 校正参数", "en": "#### 🔧 Correction"},
        ...
        "ext_result": {"zh": "#### 📊 结果 (点击修正)", "en": "#### 📊 Result (Click to fix)"},
        ...
        "msg_no_lut": {"zh": "⚠️ 请选择或上传 .npy 校准文件！", "en": "⚠️ Please upload a .npy calibration file!"},
        "msg_preview_success": {"zh": "✅ 预览", "en": "✅ Preview"},
        "msg_click_to_place": {"zh": "点击图片放置挂孔", "en": "Click to place loop"},
        "msg_conversion_complete": {"zh": "✅ 转换完成", "en": "✅ Conversion complete"},
        "msg_resolution": {"zh": "分辨率", "en": "Resolution"},
        "msg_loop": {"zh": "挂孔", "en": "Loop"},
        "msg_model_too_large": {"zh": "⚠️ 模型过大，已禁用3D预览", "en": "⚠️ Model too large, 3D preview disabled"},
        "msg_preview_simplified": {"zh": "ℹ️ 3D预览已简化", "en": "ℹ️ 3D preview simplified"},
        # ==================== Palette / Replacement ====================
        "palette_empty": {"zh": "暂无颜色，请先生成预览。", "en": "No colors yet. Generate a preview first."},
        "palette_count": {"zh": "共 {count} 种颜色", "en": "{count} colors in image"},
        "palette_hint": {"zh": "点击色块高亮预览", "en": "Click swatch to highlight in preview"},
        "palette_tooltip": {"zh": "点击高亮: {hex} ({pct}%)", "en": "Click to highlight: {hex} ({pct}%)"},
        "palette_replaced_with": {"zh": "替换为 {hex}", "en": "Replaced with {hex}"},
        "palette_click_to_select": {"zh": "点击调色板选择颜色", "en": "Click palette to select"},
        "palette_need_preview": {"zh": "❌ 请先生成预览", "en": "❌ Please generate preview first"},
        "palette_need_original": {"zh": "❌ 请先选择要替换的颜色", "en": "❌ Select a color to replace"},
        "palette_need_replacement": {"zh": "❌ 请先选择替换颜色", "en": "❌ Select a replacement color"},
        "palette_replaced": {"zh": "✅ 已替换 {src} → {dst}", "en": "✅ Replaced {src} → {dst}"},
        "palette_cleared": {"zh": "✅ 已清除所有颜色替换", "en": "✅ Cleared all replacements"},
        "palette_undo_empty": {"zh": "❌ 没有可撤销的操作", "en": "❌ Nothing to undo"},
        "palette_undone": {"zh": "↩️ 已撤销", "en": "↩️ Undone"},
        # ==================== Color Merging ====================
        "merge_enable_label": {"zh": "启用自动颜色合并 Enable Auto Color Merging", "en": "Enable Auto Color Merging"},
        "merge_enable_info": {
            "zh": "自动合并低使用率颜色到相近颜色",
            "en": "Automatically merge low-usage colors to similar colors",
        },
        "merge_threshold_label": {"zh": "使用率阈值 Usage Threshold (%)", "en": "Usage Threshold (%)"},
        ...
        "merge_preview_btn": {"zh": "🔍 预览合并效果 Preview Merge", "en": "🔍 Preview Merge"},
        "merge_apply_btn": {"zh": "✅ 应用合并 Apply Merge", "en": "✅ Apply Merge"},
        "merge_revert_btn": {"zh": "↩️ 恢复原始 Revert", "en": "↩️ Revert"},
        "merge_status_empty": {"zh": "💡 调整参数后点击预览", "en": "💡 Adjust parameters and click preview"},
        "merge_status_preview": {
            "zh": "🔍 预览: {merged} 种颜色被合并 (质量: {quality:.1f})",
            "en": "🔍 Preview: {merged} colors merged (quality: {quality:.1f})",
        },
        "merge_status_applied": {"zh": "✅ 已应用: {merged} 种颜色被合并", "en": "✅ Applied: {merged} colors merged"},
        "merge_status_reverted": {"zh": "↩️ 已恢复到原始颜色", "en": "↩️ Reverted to original colors"},
        ...
        "merge_accordion_title": {"zh": "🎨 颜色合并 Color Merging", "en": "🎨 Color Merging"},
        "lut_grid_load_hint": {"zh": "加载 LUT 后显示可用颜色", "en": "Load LUT to see available colors"},
        "lut_grid_count": {"zh": "共 {count} 种可用颜色", "en": "{count} available colors"},
        "lut_grid_search_placeholder": {"zh": "搜索色号 (如 ff0000)", "en": "Search hex (e.g. ff0000)"},
        "lut_grid_search_clear": {"zh": "清除", "en": "Clear"},
        "lut_grid_used": {"zh": "图中已使用 ({count})", "en": "Used in image ({count})"},
        "lut_grid_other": {"zh": "其他可用颜色 ({count})", "en": "Other colors ({count})"},
        "lut_grid_tooltip": {"zh": "点击选择: {hex}", "en": "Click to select: {hex}"},
        "lut_grid_picker_label": {"zh": "🎯 以色找色", "en": "🎯 Find by Color"},
        "lut_grid_picker_hint": {
            "zh": "选一个颜色，自动匹配 LUT 中最接近的物理色",
            "en": "Pick a color to find the closest match in LUT",
        },
        "lut_grid_picker_btn": {"zh": "匹配最近色", "en": "Find Nearest"},
        "lut_grid_picker_result": {
            "zh": "✅ 最接近: {hex} (距离: {dist:.1f})",
            "en": "✅ Nearest: {hex} (distance: {dist:.1f})",
        },
        "lut_grid_hue_all": {"zh": "全部", "en": "All"},
        "lut_grid_hue_red": {"zh": "红色系", "en": "Red"},
        "lut_grid_hue_orange": {"zh": "橙色系", "en": "Orange"},
        "lut_grid_hue_yellow": {"zh": "黄色系", "en": "Yellow"},
        "lut_grid_hue_green": {"zh": "绿色系", "en": "Green"},
        "lut_grid_hue_cyan": {"zh": "青色系", "en": "Cyan"},
        "lut_grid_hue_blue": {"zh": "蓝色系", "en": "Blue"},
        "lut_grid_hue_purple": {"zh": "紫色系", "en": "Purple"},
        "lut_grid_hue_neutral": {"zh": "中性色", "en": "Neutral"},
        "lut_grid_hue_fav": {"zh": "收藏", "en": "Favorites"},
        ...
        "settings_clear_output": {"zh": "🗑️ 清空输出", "en": "🗑️ Clear Output"},
        "settings_reset_counters": {"zh": "🔢 使用计数归零", "en": "🔢 Reset Counters"},
        "settings_cache_cleared": {"zh": "✅ 缓存已清空，释放了 {} 空间", "en": "✅ Cache cleared, freed {} of space"},
        ...
        "settings_output_size": {"zh": "📦 输出大小: {}", "en": "📦 Output size: {}"},
        "theme_toggle_night": {"zh": "🌙 夜间模式", "en": "🌙 Night Mode"},
        "theme_toggle_day": {"zh": "☀️ 日间模式", "en": "☀️ Day Mode"},
        # ==================== LUT Merge Tab ====================
        "tab_merge": {"zh": "🔀 色卡合并", "en": "🔀 LUT Merge"},
        "merge_title": {"zh": "### 🔀 色卡合并", "en": "### 🔀 LUT Merge"},
        "merge_desc": {
            "zh": "将不同色彩模式的LUT色卡合并为一个，获得更丰富的色彩。",
            "en": "Merge LUT cards from different color modes into one for richer colors.",
        },
        "merge_lut_primary_label": {"zh": "🎯 主色卡（6色或8色）", "en": "🎯 Primary LUT (6-Color or 8-Color)"},
        "merge_lut_secondary_label": {"zh": "➕ 副色卡（可多选）", "en": "➕ Secondary LUTs (Multi-select)"},
        "merge_lut_1_label": {"zh": "选择LUT 1（主色卡）", "en": "Select LUT 1 (Primary)"},
        "merge_lut_2_label": {"zh": "选择LUT 2（合并色卡）", "en": "Select LUT 2 (Secondary)"},
        "merge_secondary_modes": {"zh": "已选副色卡", "en": "Selected Secondary LUTs"},
        "merge_secondary_none": {"zh": "未选择副色卡", "en": "No secondary LUTs selected"},
        "merge_primary_hint": {
            "zh": "💡 请先选择一个6色或8色的主色卡",
        ...
        "merge_mode_label": {"zh": "检测到的模式", "en": "Detected Mode"},
        "merge_mode_unknown": {"zh": "未选择", "en": "Not selected"},
        "merge_dedup_label": {"zh": "Delta-E 去重阈值", "en": "Delta-E Dedup Threshold"},
        "merge_dedup_info": {
            "zh": "值越大去除的相近色越多，0=仅精确去重",
            "en": "Higher = remove more similar colors, 0 = exact dedup only",
        },
        "merge_btn": {"zh": "🔀 执行合并", "en": "🔀 Merge"},
        "merge_status_ready": {"zh": "💡 选择两个LUT后点击合并", "en": "💡 Select two LUTs then click Merge"},
        "merge_status_running": {"zh": "⏳ 合并中...", "en": "⏳ Merging..."},
        ...
        "merge_error_no_lut": {"zh": "❌ 请选择至少两个LUT文件", "en": "❌ Please select at least two LUT files"},
